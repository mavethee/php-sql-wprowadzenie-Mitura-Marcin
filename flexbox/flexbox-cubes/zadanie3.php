...
<head>
        ...
        <title>Flexbox CSS - Zadanie 3</title>
    ...
    <div class="container">
        ...
        <div class="item colorRed">
            <?php
                ...
                echo("<h1 class='page_info'><br>Flexbox CSS - Zadanie 3</h1></br>");
            ?>
        </div>
            <!--Menu boczne-->
            ...
            <audio controls autoplay loop>
                ...
                <div class="item colorGreen">
                    <?php
                    echo("<h1 class='page_info'><br>Jesteś w Flexbox CSS - Zadanie 3</h1></br>");
                    ?>
                </div>
    </div>
</body>
