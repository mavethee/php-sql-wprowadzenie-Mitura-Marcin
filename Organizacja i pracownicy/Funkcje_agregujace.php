...
<html'">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href=con-57x57.png'">
        <link rel="apple-touch-icon" sizes="60x60" href=con-60x60.png'">
        <link rel="apple-touch-icon" sizes="72x72" href=con-72x72.png'">
        <link rel="apple-touch-icon" sizes="76x76" href=con-76x76.png'">
        <link rel="apple-touch-icon" sizes="114x114" href=con-114x114.png'">
        <link rel="apple-touch-icon" sizes="120x120" href=con-120x120.png'">
        <link rel="apple-touch-icon" sizes="144x144" href=con-144x144.png'">
        <link rel="apple-touch-icon" sizes="152x152" href=con-152x152.png'">
        <link rel="apple-touch-icon" sizes="180x180" href=con-180x180.png'">
        <link rel="icon" type="image/png" sizes="192x192"  href=-icon-192x192.png'">
        <link rel="icon" type="image/png" sizes="32x32" href=-32x32.png'">
        <link rel="icon" type="image/png" sizes="96x96" href=-96x96.png'">
        <link rel="icon" type="image/png" sizes="16x16" href=-16x16.png'">
        <link rel="manifest" href=t.json'">
