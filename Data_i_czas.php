...
<body>
    <div class="nav">
        ...
        echo("<h1 class=SQL_table>Zadanie 1: Wyświetl wiek poszczegolnych pracowników</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        ...
        echo("<h1 class=SQL_table>Zadanie 2: Wyświetl wiek pracowników z działu serwisowego</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");        
        echo("<table border=1>");
        echo("<th>id_pracownicy</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 3: Wyświetlenie sumy lat wszystkich pracowników</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");
        echo("<table border=1>");
        ...
        echo("<h1 class=SQL_table>Zadanie 5: Wyświetl sumę lat kobiet</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        ...
        echo("<h1 class=SQL_table>Zadanie 6: Wyświetl sumę lat mężczyzn</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        ...
        echo("<h1 class=SQL_table>Zadanie 7: Wyświetl średnią lat pracowników w poszczególnych działach wraz z wypisanymi nazwami działów</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>dzial</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 8: Wyświetl sumę lat pracowników w poszczególnych działach wraz z wypisanymi nazwami działów</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>dzial</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 9: Wyświetl najstarszych pracowników w każdym dziale (nazwa_dział, wiek)</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>nazwa_dzial</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 10: Wyświetl najmłodszych pracowników z działu handel i serwis (nazwa_dział, wiek)</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>nazwa_dzial</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 11: Wyświetl najmłodszych pracowników z działu handel i serwis (imie, nazwa_dział, wiek)</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>imie</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 12: Wyświetl długość życia pracowników w dniach:</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>imie</th>");
        ...
        echo("<h1 class=SQL_table>Zadanie 13: Wyświetl najstarszego mężczyznę</h1>");
        echo("</h1>Użyte zapytanie SQL: ".$sql."</h1>");
        $result=$conn->query("$sql");     
        echo("<table border=1>");
        echo("<th>id_pracownicy</th>");
